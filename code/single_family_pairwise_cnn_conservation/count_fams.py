...
def count_mirgen_families(input_filename, output_filename, column_name='mirgenedb_fam'):
    """
    Reads a TSV file, counts unique values in a specified column,
    and writes the counts to a new TSV file, sorted by count descending.

    Args:
        input_filename (str): Path to the input TSV file.
        output_filename (str): Path to the output TSV file.
